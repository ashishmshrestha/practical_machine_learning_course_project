---
title: "Ashish - Practical Machine Learning Course Project"
...
## Overview
For the completetion of this assignment, we will be developing a machine learning model to predict the type of exercise performed based on different types of measurements given. We are given two files: **training** and **testing**. The first file is the training file, used to develop our algorithm, and the second is used to make our final predictions.
